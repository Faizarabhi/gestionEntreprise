...
<button type="button" class="  flex absolute bottom-7 right-[10rem] lg:right-80 z-30 justify-center items-center px-4 h-full cursor-pointer group" data-carousel-prev="">
...
<button type="button" class="flex absolute bottom-7 right-0  lg:right-24 z-30 justify-center items-center lg:px-4 h-full cursor-pointer group" data-carousel-next="">
<span class="border-l border-white inline-flex justify-center items-center  h-10  bg-secondary w-56    group-focus:outline-none">
