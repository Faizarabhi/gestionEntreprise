<template>
    <div class="mt-20">
        <div id="projects" class="">
            <h2 class="font-bold text-secondary text-3xl my-5 text-center">About US</h2>
        </div>
        <div class="flex items-center justify-center mx-8 ">
            ...
            <div class="flex-1 p-20">
                <img src="https://media.discordapp.net/attachments/950678856199729162/988454401805025280/faiza.png?width=1005&height=670" />
            </div>
        ...
        <div class="flex items-center justify-center mx-8">
            ...
            <div class="flex-1 p-20">
                <img
                    src="https://media.discordapp.net/attachments/950678856199729162/988461063173464124/ggg.png?width=1335&height=669" />
            </div>
            <div class="flex-1 p-20">
                <h3 class="font-bold text-secondary text-3xl my-5 text-center">Our Bureau</h3>
                <p>
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Qui quos laudantium incidunt dicta
